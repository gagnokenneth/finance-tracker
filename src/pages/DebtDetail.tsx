...
export function DebtDetail() {
  ...
  // Only the add keeps a dialog open long enough to have a state worth showing;
  // see the policy note in lib/optimistic.ts. Only a fixed debt can add a row —
  // a statement is generated by paying the one before it.
  const addPending = addScheduleRow.isPending
  const addError = addScheduleRow.isError
  ...
  // add branch is schedule-only by construction — see openAddRow.
